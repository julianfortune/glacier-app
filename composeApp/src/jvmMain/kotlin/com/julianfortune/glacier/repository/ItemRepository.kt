...
class ItemRepository(private val database: Database) {
        ...
        return database.itemQueries.getAll()
            ...
            .map { items ->
                ...
                items.map { i ->
                    ...
                    val categoryIds = emptyList<Category>()
                    Item(
                        i.id, i.name, categoryIds, savedWeights = emptyList() // TODO
                    )
                }
            }
    }
    ...
    suspend fun getById(id: Long): Item {
        ...
        val itemCategories = TODO()

        // TODO: Categories and weights
        return Item(item.id, item.name, itemCategories, emptyList())
    }
